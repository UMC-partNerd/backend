...
public class PromotionProjectRestController {
    ...
    @GetMapping("/promotion/mypage/{memberId}")
    ...
    public ApiResponse<PromotionProjectResponseDTO.MypagePromotionProjectPreviewListDTO> getMyPromotionProjects(@PathVariable(name = "memberId") Long memberId){//@RequestHeader("Authorization") String authorizationHeader){
        // 1. JWT 토큰 추출
